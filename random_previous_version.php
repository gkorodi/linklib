...
$sql = "SELECT * FROM links WHERE tags IS NULL AND title = ''";
...
<body>
	...
	<div id="blue">
		<div class="container">
			<div class="row">
				<h3>Random 100 of <span id="totalcount"><?=count($raw_rs['rows'])?></span>.</h3>
			</div><!-- /row -->
		</div> <!-- /container -->
	</div><!-- /blue -->
	<div class="container mtb">
		<div class="row">
			<div id="randomlist" class="col-lg-12">
				...
				<?php 
				require_once("_randomtable.php"); 
				//var_dump($resultset['rows']);
				?>
